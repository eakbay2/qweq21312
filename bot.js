...
app.get("/", (request, response) => {
  console.log(Date.now() + "Matador | Youtube Channel");
...
client.on('guildMemberAdd', async member => {
  await member.addRole(`KAYITSIZ İD`) 
...
takizaman = `• Güvenli`}require("moment-duration-format");
 ...
 let message = member.guild.channels.find(x => x.id === `KANAL İD`)
...
**・**<@&KAYIT SORUMLUSU İD> **Rolündeki Yetkililer Seninle İlgilenecektir**

**・** **Sunucumuzun Sınırsız Davet Bağlantısı** https://discord.gg/58TjGzY
